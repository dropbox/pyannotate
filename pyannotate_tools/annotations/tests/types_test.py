...
class TestTypes(unittest.TestCase):
    def test_instance_str(self):
        ...
        assert str(ClassType("Dict", [ClassType("int"), ClassType("str")])) == "Dict[int, str]"
    ...
    def test_tuple_type_str(self):
        ...
        assert str(TupleType([ClassType("int"), ClassType("str")])) == "Tuple[int, str]"
    ...
    def test_optional(Self):
        ...
        assert str(UnionType([ClassType("None"), ClassType("str"), ClassType("int")])) == "Union[None, str, int]"
